...
if(isset($_POST["login"])) {
    ...
    if($user_name != null && $user_name != "" && $user_pass != null && $user_pass != "") {
        ...
        if($user != null) {
            $_SESSION["admin"]["id"] = $user->getUser_id();
            $_SESSION["admin"]["name"] = $user->getUser_name();
            $_SESSION["admin"]["email"] = $user->getUser_email();
            $_SESSION["admin"]["fullname"] = $user->getUser_fullname();
            $_SESSION["admin"]["permission"] = $user->getUser_permission();
