...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link <?=getCollapsed("em")?>" data-bs-target="#nhanvien-nav" data-bs-toggle="collapse" href="#">
    <i class="bi bi-person-badge"></i></i><span>Nhân viên</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="nhanvien-nav" class="nav-content collapse <?=getShow("em")?>" data-bs-parent="#sidebar-nav">
      <li>
