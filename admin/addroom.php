                ...
                <div class="card">
                    <div class="card-body">
                        <form action=""
                            ...
                            <div class="mb-3 row">
                                <label for="hotelName" class="col-sm-2 col-form-label fw-bold">Tên phòng</label>
                                <div class="col-sm-10">
                                    <input type="text"
                                        class="form-control"
                                        id="hotelName"
                            ...
                            <div class="mb-3 row d-flex justify-content-center">
                                ...
                                <a class="btn btn-secondary col-md-2 col-sm-3 mt-3" href="/hostay/admin/rooms.php">Hủy</a>
                            </div>
                        </form>
                    </div>
                </div>
