        ...
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            ...
            <p class="row color-text-a align-items-center">
              ...
              <span class="col-11">
                Trong trường hợp khẩn cấp, bạn có thể gọi cho chúng tôi bằng số hotline.
              </span>
            </p>
            <p class="row color-text-a align-items-center">
              <i class="bi bi-buildings col-1 fs-3" style="color: #2eca6a"></i>
              <span class="col-11">
                Hotline hỗ trợ khách hàng 24/7 0833170320
              </span>
            </p>
          </div>
        </div>
            ...
            <div class="col-md-4 icon-box section-b2">
              ...
              <div class="icon-box-content table-cell">
                ...
                <div class="icon-box-content">
                  <p class="mb-1">Email.
                    <span class="color-a">kiyohome111@gmail.com</span>
                  </p>
                  <p class="mb-1">Điện thoại.
                    <span class="color-a">+84 833 170 320</span>
                  </p>
                </div>
              </div>
            </div>
