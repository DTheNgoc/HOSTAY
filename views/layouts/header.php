...
<head>
    ...
    <title><?= $title ?></title>
    <!-- Favicons -->
    <link rel="shortcut icon" href="\htdocs\hostay\public\favicon-32x32.png" type="image/x-icon">
...
<body>
    ...
    <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand text-brand" href="/hostay/"><span class="color-b">Kiyo-Home</span></a>
