...
<div class="intro intro-carousel swiper position-relative">
  ...
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide carousel-item-a intro-item bg-image"
      style="background-image: url(/hostay/assets/img-views/slide1.jpg)">
    ...
    <div class="swiper-slide carousel-item-a intro-item bg-image"
      style="background-image: url(/hostay/assets/img-views/slide2.jpg)">
      <div class="overlay overlay-a"></div>
      <div class="intro-content display-table">
        <div class="table-cell">
          <div class="container">
    ...
    <div class="swiper-slide carousel-item-a intro-item bg-image"
      style="background-image: url(/hostay/assets/img-views/slide3.jpg)">
      <div class="overlay overlay-a"></div>
      <div class="intro-content display-table">
        <div class="table-cell">
          <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between pb-5">
              <div class="title-box">
                <h2 class="title-a">Các chi nhánh</h2>
              </div>
              <div class="title-link">
                <a href="/hostay/views/rooms.php">Tất cả phòng
                  <span class="bi bi-chevron-right"></span>
              ...
              <div class="row">
                <div class="col-sm-12 col-md-6">
                  <div class="testimonial-img">
                    <img src="/hostay/public/testimonials/11t1.jpg" alt="" class="img-fluid">
                  </div>
                </div>
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="testimonials-content">
                    <p class="testimonial-text">
                      Tốc độ truy cập trang web Kiyo-Home rất nhanh, giúp tôi đặt phòng rất nhanh chóng.
                    </p>
                  </div>
                  <div class="testimonial-author-box">
                    <img src="/hostay/public/testimonials/1t1.jpg" alt="" class="testimonial-avatar">
                    <h5 class="testimonial-author">Giang Truong</h5>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item-a swiper-slide">
            <div class="testimonials-box">
              <div class="row">
                <div class="col-sm-12 col-md-6">
                  <div class="testimonial-img">
                    <img src="/hostay/public/testimonials/22t2.jpg" alt="" class="img-fluid">
                  </div>
                </div>
                <div class="col-sm-12 col-md-6">
                  <div class="testimonial-ico">
                  ...
                  <div class="testimonials-content">
                    <p class="testimonial-text">
                      Tôi đánh giá rất cao chất lượng phòng ở Kiyo-Home
                    </p>
                  </div>
                  <div class="testimonial-author-box">
                    <img src="/hostay/public/testimonials/t2-avatar.jpg" alt="" class="testimonial-avatar">
                    <h5 class="testimonial-author">Truong Giang</h5>
                  </div>
                </div>
              </div>
            </div>
...
<script type="module">
  document.addEventListener('DOMContentLoaded', function() {
    ...
    lightGallery(document.getElementById('lightgallery'), {
      pause: 3000,
      // Các tùy chọn khác của lightGallery
    });
  });
</script>
