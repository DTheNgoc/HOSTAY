...
if (isset($_POST["checkin"])) {
    ...
    $target_dir = "/hostay/admin/images/identity_card";
    ...
    if (!empty($checkinCode) && !empty($checkinDate)) {
        ...
        if (
            ...
            if ($targetFirstFile && $targetSecondFile) {
                ...
                if ($checkinModel->addCheckin($checkinItem)) {
                    ...
                    DeleteFile($targetFirstFile);
                    DeleteFile($targetSecondFile);
                    headerRedirectViews("err", "checkin_err", $url);
                }
            } else {
                // Xóa file nếu một trong hai upload thất bại
                if ($targetFirstFile) DeleteFile($targetFirstFile);
                if ($targetSecondFile) DeleteFile($targetSecondFile);
